...
@router.post("/cr", status_code=status.HTTP_201_CREATED, response_model=schemas.CRcordless)
...
@router.get("/cr/{id}", status_code=status.HTTP_201_CREATED, response_model=schemas.CRcordless)
...
@router.get("/cr", status_code=status.HTTP_201_CREATED, response_model=List[schemas.CRcordless])
...
@router.delete("/cr/{id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.put("/cr/{id}", response_model=schemas.CRcordless)
